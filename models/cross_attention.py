...
class CrossAttention(nn.Module):
    ...
    Key và Value:
        Lấy từ Vision Transformer Encoder.
    ...
    Output:
        ...
        attention_weights:
            [B, num_heads, text_length, num_patches]
    """
    ...
    def __init__(
        ...
        self.text_input_norm = nn.LayerNorm(
    ...
    def forward(
        ...
        # --------------------------------------------------
        normalized_text = self.text_input_norm(
            text_states
        )
