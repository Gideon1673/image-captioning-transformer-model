...
class MaskedMultiHeadSelfAttention(nn.Module):
    ...
    Causal mask bảo đảm token ở vị trí hiện tại không nhìn
    thấy các token đứng phía sau.
    ...
    Output:
        ...
        attention_weights:
            [B, num_heads, sequence_length, sequence_length]
    """
    ...
    def forward(
        ...
        # --------------------------------------------------
        normalized_text = self.input_norm(
            text_embeddings
        )
        ...
        combined_mask = causal_mask.unsqueeze(
            0
        ).unsqueeze(0)
